    ...
    return (
        ...
        works!`}
            ...
            <div className="w-full h-[890px] -top-50 md:-top-40  flex items-center justify-center bg-red-transparent absolute">
                <button className="sticky font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 z-30 md:text-base text-black text-xs  w-fit mx-auto "
            ...
            >
                <defs>
                    {/* Define linear gradient for stroke 1 */}
                    <linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#FFD700" />
                        <stop offset="100%" stopColor="red" />
                    </linearGradient>

                    {/* Define linear gradient for stroke 2 */}
                    <linearGradient id="gradient2" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#FFDDB7" />
                        <stop offset="100%" stopColor="orange" />
                    </linearGradient>

                    {/* Define linear gradient for stroke 3 */}
                    <linearGradient id="gradient3" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#B1C5FF" />
                        <stop offset="100%" stopColor="green" />
                    </linearGradient>

                    {/* Define linear gradient for stroke 4 */}
                    <linearGradient id="gradient4" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#4FABFF" />
                        <stop offset="100%" stopColor="cyan" />
                    </linearGradient>

                    {/* Define linear gradient for stroke 5 */}
                ...
                {/* Add other motion.path elements with similar attributes for each stroke */}
                <motion.path
